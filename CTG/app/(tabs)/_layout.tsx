...
export default function TabLayout() {
  return (
    <Tabs screenOptions={{ tabBarActiveTintColor: 'blue', tabBarActiveBackgroundColor: 'orange', tabBarInactiveBackgroundColor: 'grey', tabBarInactiveTintColor: 'white' }}>
      ...
      <Tabs.Screen name="BOLO" options={{ headerShown: false, title: "", tabBarIcon: ({ color }) => <Icon name="tasks" size={25} color={color} /> }} />
