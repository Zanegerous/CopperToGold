...
export default function Colors() {
    let backgroundColor = 'bg-zinc-900';
    return (

        <SafeAreaView className={'flex-1 self-center m-2 flex-col ' + backgroundColor}>
            ...
            <View className=" w-48 h-48 m-1" style={{ backgroundColor: '#ffffff' }}></View>
